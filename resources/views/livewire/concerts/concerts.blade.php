        ...
        <div class="flex items-center justify-between pb-4 dark:bg-gray-900">
            <div>
                ...
                <button id="dropdownActionButton" data-dropdown-toggle="dropdownAction" class="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
                    <span class="sr-only">{{ __('web.action_buttons') }}</span>
                    {{ __('web.action_buttons') }}
                    ...
                    <tr class="bg-gray-100 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-3 py-4">
                            <div class="flex justify-center">
                                <div class="h-2.5 w-2.5 rounded-full bg-{{ $status = $concert->is_expired ? 'red' : 'green' }}-500 mr-2"></div>
                            </div>
                        </td>

                        <td class="px-6 py-4">
                            <a onclick="Livewire.dispatch('openModal', { component: 'show-concert', arguments: { id: {{ $concert->id }} }})" href="javascript:void(0)" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                {{ __('web.show_details') }}
                            </a>
                        </td>
                    </tr>
