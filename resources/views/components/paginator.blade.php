<nav aria-label="Paginator">
    <ul class="inline-flex -space-x-px text-base h-10">
        <li>
            ...
            @else
                <button wire:click="previousPage" class="flex items-center justify-center px-4 h-10 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white">
                    {{ __('web.previous') }}
                </button>
            @endif
        </li>
        ...
        @else
            <button wire:click="nextPage" class="flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white">
                {{ __('web.next') }}
            </button>
        @endif
    </ul>
